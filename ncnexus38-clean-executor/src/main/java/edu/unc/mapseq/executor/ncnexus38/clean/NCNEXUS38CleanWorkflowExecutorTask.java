...
import edu.unc.mapseq.workflow.ncnexus38.clean.NCNEXUS38CleanWorkflow;

public class NCNEXUS38CleanWorkflowExecutorTask extends TimerTask {

    private static final Logger logger = LoggerFactory.getLogger(NCNEXUS38CleanWorkflowExecutorTask.class);
    ...
    public NCNEXUS38CleanWorkflowExecutorTask() {
        super();
    }
        ...
        try {
            ...
            if (CollectionUtils.isNotEmpty(attempts)) {
                ...
                for (WorkflowRunAttempt attempt : attempts) {
                    ...
                    NCNEXUS38CleanWorkflow cleanWorkflow = new NCNEXUS38CleanWorkflow();
