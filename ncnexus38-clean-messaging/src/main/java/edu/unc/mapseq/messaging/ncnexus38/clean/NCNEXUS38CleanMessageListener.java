package edu.unc.mapseq.messaging.ncnexus38.clean;
...
public class NCNEXUS38CleanMessageListener extends AbstractSequencingMessageListener {

    private static final Logger logger = LoggerFactory.getLogger(NCNEXUS38CleanMessageListener.class);

    public NCNEXUS38CleanMessageListener() {
        super();
    }
